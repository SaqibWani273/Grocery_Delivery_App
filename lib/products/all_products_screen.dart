                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CircleAvatar(
                                  ...
                                  radius: 20,
                                  child:  const Icon(Icons.sort, color: AppColors.primaryDark),
                                ),
                        ],
                      ),
                    ),
                            ...
                            children: [
                               ...
                               GestureDetector(
                                ...
                                child: CircleAvatar(
                                  backgroundColor: Colors.white,
                                  radius: 20,
                                  child:  const Icon(Icons.arrow_back_ios_new, color: AppColors.primaryDark),
                                ),
                              ).animate().fadeIn(duration: 500.ms, curve: Curves.easeIn).scale(duration: 200.ms, curve: Curves.easeIn),
                          
                          const Text("Daily Foods", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.primaryLight)),
                                      CartIcon(),
                          ...
                          child: Row(
                            children: [
                             ...
                             ... categories.map((category) => Padding(
                                                       ...
                                                       child: Text(category, style:  TextStyle(fontSize: 16, color: categories.indexOf(category) == 2 ? AppColors.primaryAccent : AppColors.textSecondaryGrey)),
                                                     )
                            ...
                            begin:  Offset(2.0, 0),
                             ...
                             duration: 800.ms, curve: Curves.ease),
